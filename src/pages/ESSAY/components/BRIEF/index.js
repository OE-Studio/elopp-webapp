...
export const Brief = () =>{
    return (
        <div className="sticky top-32 left-0 text-sm">
            <p>In this brief</p>
            ...
            <Link to="/" className="text-base mt-5 border border-[#5B5B5B] rounded-full inline-flex items-center gap-2 px-4 py-2 light-hover">
                <Trolley/>
                Go to store
            </Link>
        </div>
