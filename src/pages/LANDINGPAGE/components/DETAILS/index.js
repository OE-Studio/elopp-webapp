...
export const ItemDetails = () =>{
    ...
    return (
        <div className="w-full">
            ...
            <div className="mt-11">
                <p className="text-2xl">{currentItem.name}</p>
            ...
            <div className="mt-7">
                <table className="w-full">
                    ...
                    <tbody className="">
                        <tr>
                            ...
                            <td className="flex items-center justify-end py-4">
                                <div className="inline-flex items-center justify-end">
                                    <div onClick={removeOne} className="w-9 h-9 rounded-full flex items-center justify-center soft-shadow border border-[#DFDFDF] bg-white"><DarkMinus/></div>

                                    <div className="flex items-center px-4 pointer-events-none">{quantity}</div>

                                    <div onClick={addOne} className="w-9 h-9 rounded-full flex items-center justify-center soft-shadow border border-[#DFDFDF] bg-white"><DarkPlus/></div>
                                </div>
                            </td>
                        </tr>
                            ...
                            <td className="flex items-center justify-end py-4">
                                <div className="inline-flex items-center justify-end gap-2 lg:gap-4 text-sm lg:text-base">
                                    {currentItem.availableSize.map(s=>{
                                        return <div className={`px-2 lg:px-4 h-8 lg:h-9 rounded-full flex items-center justify-center soft-shadow border border-[#DFDFDF] cursor-pointer ${s === size ? "text-white bg-[#333333]" : "bg-white"}`} onClick={()=>setSize(s)}>{s}</div>
                                    })}
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>{currentItem.price * quantity}</td>
                            <td className="flex items-center justify-end py-4">
                                <div onClick={updateCartHandler} className={`inline-flex items-center justify-center h-11 px-4 bg-[#333333] gap-2 text-white rounded-full cursor-pointer`}>
