    ...
    return (
        <div className="w-full">
            <div className="flex items-center justify-between sticky top-0 bg-white py-4">
                <div onClick={changeCurrentHandler} className="w-9 h-9 rounded-full flex items-center justify-center border border-[#DFDFDF]"><CloseIcon/></div>
            ...
            <div className="mt-7">
                <table className="w-full">
                    ...
                    <tbody className="">
                        <tr>
                            ...
                            <td className="flex items-center justify-end py-4">
                                <div className="inline-flex items-center justify-end">
                                    <div onClick={removeOne} className="w-9 h-9 rounded-full flex items-center justify-center border border-[#DFDFDF] bg-white"><DarkMinus/></div>

                                    <div className="flex items-center px-4 pointer-events-none">{quantity}</div>

                                    <div onClick={addOne} className="w-9 h-9 rounded-full flex items-center justify-center  border border-[#DFDFDF] bg-white"><DarkPlus/></div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>&#8358; {(currentItem.price * quantity).toLocaleString()}</td>
                            <td className="flex items-center justify-end py-4">
